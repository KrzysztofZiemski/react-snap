# This is fork of library  react-snap [![Build Status](https://travis-ci.org/stereobooster/react-snap.svg?branch=master)](https://travis-ci.org/stereobooster/react-snap) [![npm](https://img.shields.io/npm/v/react-snap.svg)]


## Myselfchanges
enable in packege.json puppeteer options

"reactSnap":{
  "puppeteer":{}
}
Read [puppeteer doc](https://pptr.dev/api/puppeteer.configuration)
-------------------------------------------------
